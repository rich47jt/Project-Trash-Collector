...
namespace TrashCollector.Controllers
{
    public class CustomersController : Controller
    {
        ...
        //create layout page for customer
        //Reroute view for customer to new layoutpage page
        //can view details of pick ups
        public IActionResult DetialofPickup(Customer customer)
        {
            var pickup = customer;
            pickup = _context.Customers.Where(c => c.PickUpDay == pickup.PickUpDay && c.Start == pickup.Start && c.End == pickup.End).SingleOrDefault();  
            return View(pickup);
        }
